...
from djoser.urls.converters import UserLookupConverter
from djoser.urls.utils import create_configurable_dispatcher

register_converter(UserLookupConverter, "djoser_lookup")
...
if user_detail_dispatcher:
    ...
    user_detail_update_delete = path(
        f"users/<djoser_lookup:{UserRetrieveView.lookup_field}>/",
